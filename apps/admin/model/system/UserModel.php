...
class UserModel extends Model
{
    ...
    // 获取用户code
    public function getUCode($username)
    {
        return parent::table('ay_user')->where("username='$username'")->value('ucode');
    }
    ...
    // 获取指定用户角色表
    public function getUserRole($ucode)
    {
        $table = array(
            'ay_role',
            'ay_user_role'
    ...
    // 获取指定用户角色表
    public function getUserByRole($rcode)
    {
    ...
    {
        return parent::table('ay_user')->where("username='$username'")->value('Id');
    }
    ...
    {
        $result = parent::table('ay_user')->where("Id='$Id'")->update($data);
        return $result;
    }
}